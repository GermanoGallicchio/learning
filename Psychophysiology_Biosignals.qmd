...
1. **Principles of biosignals propagation**
2. **Acquisition**
   - The recording chain
3. **Biosignals processing**
...
![waves of different frequency](./Psychophysiology_files/waveformsFrequency.png){.lightbox}
:::
:::{.column width=50%}
...
# Signal Conditioner > Filtering > Low-pass {.scrollable}

Filters _out_ fast (high) frequencies and therefore retains slow (low) frequencies

![low-pass filtering](./Psychophysiology_files/waveformsLowpass.png)

:::aside
Also called "high-cut" filter, but less frequently.
:::

# Signal Conditioner > Filtering > High-pass {.scrollable}

Filters _out_ slow (low) frequencies and therefore retains fast (high) frequencies

![high-pass filtering](./Psychophysiology_files/waveformsHighpass.png)
...
# Analog-to-digital conversion (ADC) > Digitization {.nostretch .scrollable}

![sampling a waveform](./Psychophysiology_files/waveformsSampling.png)
...
[Too low sampling: you might miss important moments in the football game (e.g., a goal) or the movement of the clouds (e.g., a sudden change in direction). Distortion due to undersampling is called **aliasing**.]{.fragment}
...
[Caveats with the acquisition and processing of each specific biological signal of psychological interest.]{.fragment}
